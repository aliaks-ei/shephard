-- Recreate the write RPC so PostgREST receives a schema-change event, then
-- explicitly reload its schema cache. The function already exists in the
-- authorization-boundary migration; this repairs a stale hosted API cache.
